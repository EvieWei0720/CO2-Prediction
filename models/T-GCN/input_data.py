...
def load_CO2_data(dataset):
    CO2_adj = pd.read_csv(r'data/CO2_adj.csv',header=None)
    adj = np.mat(CO2_adj)
    CO2_tf = pd.read_csv(r'data/CO2_speed.csv')
    return CO2_tf, adj

def load_CO2D1_data(dataset):
    CO2_adj = pd.read_csv(r'data/CO2D1_adj.csv',header=None)
    adj = np.mat(CO2_adj)
    CO2_tf = pd.read_csv(r'data/CO2D1_speed.csv')
    return CO2_tf, adj
