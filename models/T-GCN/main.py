...
from input_data import preprocess_data,load_sz_data,load_los_data, load_CO2_data,load_CO2D1_data
...
flags.DEFINE_string('dataset', 'CO2', 'sz or los.')
flags.DEFINE_string('model_name', 'tgcn', 'tgcn')
model_name = 'tgcn'
data_name = 'CO2'
train_rate =  FLAGS.train_rate = 0.8
seq_len = 7
output_dim = pre_len = FLAGS.pre_len = 1
batch_size = 32
lr = FLAGS.learning_rate
training_epoch = 6000
gru_units = FLAGS.gru_units= 64
...
if data_name == 'CO2':
    data, adj = load_CO2_data('CO2') 
if data_name == 'CO2D1':
    data, adj = load_CO2D1_data('CO2D1') 
